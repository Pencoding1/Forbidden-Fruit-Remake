...
style navigation_button:
    ...
    idle_background Frame('/gui/button/navigation.png')
    hover_background Frame('/gui/button/navigation_hover.png')
...
screen about():
    ...
    ## screen.
    use game_menu(_("Về chúng tôi"), scroll="viewport"):
